...
items:
  - icon: globe
    title: Sites vitrine
    description: Un site professionnel pour présenter votre activité et attirer de
      nouveaux clients. Design sur-mesure, responsive et optimisé SEO.
  - icon: shopping-cart
    title: Sites e-commerce
    description: Vendez vos produits en ligne avec une boutique performante et
      sécurisée. Intégration Stripe, gestion des stocks et tableau de bord.
  - icon: code
